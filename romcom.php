...
<html>
  ...
  <body>
    ...
    <main class="main">
	<div id="box">
	         <div class="box2"><a href="sessions.php">OUT NOW</a> | <a href="action.php">ACTION</a> | <a href="art.php">ART/FOREIGN</a> | <a href="kids.php">KIDS</a> | ROMANTIC COMEDY</div>

       		 <a href="htbs.php"><div class="floating-box"><img src="htbs.jpg"></div></a>
