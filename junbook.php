...
<html>
  ...
  <body>
    ...
    <main class="main">
	<div id="box4">
		<div class="box2">The Jungle Book</div>
      		

		<table style="width:100%;">
  
  		<tr>
   			 <td class="td1"><img src="junbook.jpg"></br>
    		</td>
		...
		<td class="td3">The Jungle Book</br>
				Jon Favreau</br>
				Bill Murray, Ben Kingsley, Idris Elba</br>
				Action, Adventure, Childrens</br>
				PG</br>
				106 Minutes</br>
				An all-new live-action epic adventure about Mowgli (newcomer Neel Sethi), a man-cub who's been raised by a family of wolves. But Mowgli finds he is no longer welcome in the jungle when fearsome tiger Shere Khan (voice of Idris Elba), who bears the scars of Man, promises to eliminate what he sees as a threat.</br>
			...
			<fieldset class="fieldset">
				<legend>Booking Information - Fill Out Form Below</legend>
					...
					<select name="movie" required="required" >
						<option value="name">The Jungle Book</option>
